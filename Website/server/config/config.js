...
const CONFIG = {
  ...
  // Autodesk Design Automation and Workitem config
  DESIGN_AUTOMATION : {
    ENGINE: "Autodesk.Inventor+2026",
    NICKNAME: process.env.FORGE_NICKNAME || "daa",
    APPBUNDLE_ID: "joints_constraints_appbundle",
    ACTIVITY_ID: "joints_constraints_activity",
    ACTIVITY_ALIAS: "my_current_version",
    WORKITEM_TIMEOUT_MINUTES: 30,
    WORKITEM_CHECK_INTERVAL: 10000 // 10 seconds
  }
